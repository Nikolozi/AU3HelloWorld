//
//  AU3HelloWorldMIDIExtensionDSPKernel.hpp
...
#import "AU3HelloWorldMIDIExtension-Swift.h"
#import "AU3HelloWorldMIDIExtensionParameterAddresses.h"

constexpr uint16_t kMaxVelocity = std::numeric_limits<std::uint16_t>::max();

/*
 AU3HelloWorldMIDIExtensionDSPKernel
 As a non-ObjC class, this is safe to use from render thread.
 */
class AU3HelloWorldMIDIExtensionDSPKernel {
public:
    ...
    // Add a case for each parameter in AU3HelloWorldMIDIExtensionParameterAddresses.h
    void setParameter(AUParameterAddress address, AUValue value) {
        switch (address) {
            case AU3HelloWorldMIDIExtensionParameterAddress::midiNoteNumber:
                mNextNoteToSend = (uint8_t)value;
                break;
            case AU3HelloWorldMIDIExtensionParameterAddress::sendNote:
    ...
    void handleMIDIEventList(AUEventSampleTime now, AUMIDIEventList const* midiEvent) {
        /*
         ...
         auto thisObject = static_cast<AU3HelloWorldMIDIExtensionDSPKernel *>(context);

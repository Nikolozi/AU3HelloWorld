//
//  AU3HelloWorldMIDIExtensionAudioUnit.mm
//  AU3HelloWorldMIDIExtension
//
//  Created by Nikolozi on 16.11.25.
//

#import "AU3HelloWorldMIDIExtensionAudioUnit.h"

#import <AVFoundation/AVFoundation.h>
#import <CoreAudioKit/AUViewController.h>
#import <CoreMIDI/CoreMIDI.h>

#import "AU3HelloWorldMIDIExtensionAUProcessHelper.hpp"
#import "AU3HelloWorldMIDIExtensionDSPKernel.hpp"


// Define parameter addresses.

@interface AU3HelloWorldMIDIExtensionAudioUnit ()
...
@implementation AU3HelloWorldMIDIExtensionAudioUnit {
    // C++ members need to be ivars; they would be copied on access if they were properties.
    AU3HelloWorldMIDIExtensionDSPKernel _kernel;
...
- (void)setupParameterCallbacks {
    ...
    __block AU3HelloWorldMIDIExtensionDSPKernel *kernel = &_kernel;

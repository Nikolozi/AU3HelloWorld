...
private let log = Logger(subsystem: "com.nikolozi.AU3HelloWorldMIDIExtension", category: "AudioUnitViewController")

public class AudioUnitViewController: AUViewController, AUAudioUnitFactory {
    var audioUnit: AUAudioUnit?
    
    var hostingController: HostingController<AU3HelloWorldMIDIExtensionMainView>?
	...
	*/
    ...
    public func createAudioUnit(with componentDescription: AudioComponentDescription) throws -> AUAudioUnit {
        audioUnit = try AU3HelloWorldMIDIExtensionAudioUnit(componentDescription: componentDescription, options: [])
        
        guard let audioUnit = self.audioUnit as? AU3HelloWorldMIDIExtensionAudioUnit else {
            log.error("Unable to create AU3HelloWorldMIDIExtensionAudioUnit")
            return audioUnit!
        }
        ...
        audioUnit.setupParameterTree(AU3HelloWorldMIDIExtensionParameterSpecs.createAUParameterTree())
    ...
    private func configureSwiftUIView(audioUnit: AUAudioUnit) {
        ...
        let content = AU3HelloWorldMIDIExtensionMainView(parameterTree: observableParameterTree)

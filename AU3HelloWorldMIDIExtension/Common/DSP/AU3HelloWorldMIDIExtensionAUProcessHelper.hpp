//
//  AU3HelloWorldMIDIExtensionAUProcessHelper.hpp
...
#include <vector>
#include "AU3HelloWorldMIDIExtensionDSPKernel.hpp"

//MARK:- AUProcessHelper Utility Class
class AUProcessHelper
{
public:
    AUProcessHelper(AU3HelloWorldMIDIExtensionDSPKernel& kernel)
    : mKernel{kernel} {}
...
private:
    AU3HelloWorldMIDIExtensionDSPKernel& mKernel;
};

//
//  AU3HelloWorldEffectExtensionDSPKernel.hpp
...
#import "AU3HelloWorldEffectExtension-Swift.h"
#import "AU3HelloWorldEffectExtensionParameterAddresses.h"

/*
 AU3HelloWorldEffectExtensionDSPKernel
 As a non-ObjC class, this is safe to use from render thread.
 */
class AU3HelloWorldEffectExtensionDSPKernel {
public:
    ...
    // Add a case for each parameter in AU3HelloWorldEffectExtensionParameterAddresses.h
    void setParameter(AUParameterAddress address, AUValue value) {
        switch (address) {
            case AU3HelloWorldEffectExtensionParameterAddress::gain:
                mGain = value;
                break;
        }
    }
    ...
    void process(std::span<float const*> inputBuffers, std::span<float *> outputBuffers, AUEventSampleTime bufferStartTime, AUAudioFrameCount frameCount) {
        /*
         ...
         modify the check in [AU3HelloWorldEffectExtensionAudioUnit allocateRenderResourcesAndReturnError]
         */
    ...
    void handleMIDIEventList(AUEventSampleTime now, AUMIDIEventList const* midiEvent) {
        auto visitor = [] (void* context, MIDITimeStamp timeStamp, MIDIUniversalMessage message) {
            auto thisObject = static_cast<AU3HelloWorldEffectExtensionDSPKernel *>(context);

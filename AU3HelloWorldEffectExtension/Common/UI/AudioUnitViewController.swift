...
private let log = Logger(subsystem: "com.nikolozi.AU3HelloWorldEffectExtension", category: "AudioUnitViewController")

public class AudioUnitViewController: AUViewController, AUAudioUnitFactory {
    var audioUnit: AUAudioUnit?
    
    var hostingController: HostingController<AU3HelloWorldEffectExtensionMainView>?
	...
	*/
    ...
    public func createAudioUnit(with componentDescription: AudioComponentDescription) throws -> AUAudioUnit {
        audioUnit = try AU3HelloWorldEffectExtensionAudioUnit(componentDescription: componentDescription, options: [])
        
        guard let audioUnit = self.audioUnit as? AU3HelloWorldEffectExtensionAudioUnit else {
            log.error("Unable to create AU3HelloWorldEffectExtensionAudioUnit")
            return audioUnit!
        }
        ...
        audioUnit.setupParameterTree(AU3HelloWorldEffectExtensionParameterSpecs.createAUParameterTree())
    ...
    private func configureSwiftUIView(audioUnit: AUAudioUnit) {
        ...
        let content = AU3HelloWorldEffectExtensionMainView(parameterTree: observableParameterTree)

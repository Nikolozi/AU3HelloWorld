//
//  AU3HelloWorldEffectExtensionAUProcessHelper.hpp
...
#include <vector>
#include "AU3HelloWorldEffectExtensionDSPKernel.hpp"

//MARK:- AUProcessHelper Utility Class
class AUProcessHelper
{
public:
    AUProcessHelper(AU3HelloWorldEffectExtensionDSPKernel& kernel, UInt32 inputChannelCount, UInt32 outputChannelCount)
    : mKernel{kernel},
...
private:
    AU3HelloWorldEffectExtensionDSPKernel& mKernel;

//
//  AU3HelloWorldExtensionAUProcessHelper.hpp
...
#include <vector>
#include "AU3HelloWorldExtensionDSPKernel.hpp"

//MARK:- AUProcessHelper Utility Class
class AUProcessHelper
{
public:
    AUProcessHelper(AU3HelloWorldExtensionDSPKernel& kernel, UInt32 outputChannelCount)
    : mKernel{kernel},
...
private:
    AU3HelloWorldExtensionDSPKernel& mKernel;

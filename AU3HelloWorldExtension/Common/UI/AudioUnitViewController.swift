...
private let log = Logger(subsystem: "com.nikolozi.AU3HelloWorldExtension", category: "AudioUnitViewController")

public class AudioUnitViewController: AUViewController, AUAudioUnitFactory {
    var audioUnit: AUAudioUnit?
    
    var hostingController: HostingController<AU3HelloWorldExtensionMainView>?
	...
	*/
    ...
    public func createAudioUnit(with componentDescription: AudioComponentDescription) throws -> AUAudioUnit {
        audioUnit = try AU3HelloWorldExtensionAudioUnit(componentDescription: componentDescription, options: [])
        
        guard let audioUnit = self.audioUnit as? AU3HelloWorldExtensionAudioUnit else {
            log.error("Unable to create AU3HelloWorldExtensionAudioUnit")
            return audioUnit!
        }
        ...
        audioUnit.setupParameterTree(AU3HelloWorldExtensionParameterSpecs.createAUParameterTree())
    ...
    private func configureSwiftUIView(audioUnit: AUAudioUnit) {
        ...
        let content = AU3HelloWorldExtensionMainView(parameterTree: observableParameterTree)

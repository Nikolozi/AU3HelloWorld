//
//  AU3HelloWorldExtensionDSPKernel.hpp
...
#import "AU3HelloWorldExtension-Swift.h"
#import "AU3HelloWorldExtensionParameterAddresses.h"

/*
 AU3HelloWorldExtensionDSPKernel
 As a non-ObjC class, this is safe to use from render thread.
 */
class AU3HelloWorldExtensionDSPKernel {
public:
    ...
    // Add a case for each parameter in AU3HelloWorldExtensionParameterAddresses.h
    void setParameter(AUParameterAddress address, AUValue value) {
        switch (address) {
            case AU3HelloWorldExtensionParameterAddress::gain:
                mGain = value;
                break;
        }
    }
    ...
    void handleMIDIEventList(AUEventSampleTime now, AUMIDIEventList const* midiEvent) {
        auto visitor = [] (void* context, MIDITimeStamp timeStamp, MIDIUniversalMessage message) {
            auto thisObject = static_cast<AU3HelloWorldExtensionDSPKernel *>(context);
